...
const ListFeed = () => {
  ...
  const fetchData = () => {
    ...
    axios
      .get(`${apiURL}/posts/pages/`)
      .then((response) => (pageCount = response.data))
      .catch((error) => console.log(error));
    ...
    setHasNextPage(pageNumber < pageCount);
  ...
  return (
    <section>
      ...
      {window.location.pathname.includes("search") ? (
        ...
        <InfiniteScroll
          dataLength={postLength} //This is important field to render the next data
          next={fetchData}
          hasMore={true}
          // loader={<h4>Loading...</h4>}
        ></InfiniteScroll>
